        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset('assets/foodzer logo (2).png',width: MediaQuery.of(context).size.width*0.6,),
              Expanded(child: SizedBox()),
              Text('Login or create an account',style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500
              ),),
              SizedBox(height: 20,),
              Text('Login or create an account to receive rewards and save your details for a faster checkout experience',style: TextStyle(
                  fontSize: 12,
              ...
              //         child: Row(
              //           children: [
              //             Icon(Icons.person,color: fPrimary,),
              //
              //             Expanded(
              //               child: Center(
              //                 child: Text("Continue as Guest",style: GoogleFonts.poppins(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.mobile_screen_share_outlined,color: Colors.red,),
                          Expanded(
                            child: Center(
